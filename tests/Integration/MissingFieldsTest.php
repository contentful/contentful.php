...
class MissingFieldsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMissingFields()
    {
        ...
        $client->parseJson('{"sys":{"type":"Space","id":"rue07lqzt1co"},"name":"Product Catalog App (App Stor)","locales":[{"code":"en-US","default":true,"name":"U.S. English","fallbackCode":null}]}');
    ...
    public function testMissingFieldsInAssets()
    {
        ...
        $asset = $client->parseJson($assetJson);
