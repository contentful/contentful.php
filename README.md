...
|---|---|
| [AGENTS.md](./AGENTS.md) | Agent-first context directory — read this before touching code |
| [ARCHITECTURE.md](./ARCHITECTURE.md) | Internal structure, data flows, integration points, key dependencies |
| [CONTRIBUTING.md](./CONTRIBUTING.md) | Development setup, test commands, release process, CI overview |
| [docs/ADRs/](./docs/ADRs/) | Architecture Decision Records — why things look the way they do |
| [docs/specs/](./docs/specs/) | Active implementation specs |
